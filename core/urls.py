...
from .frontend_views import ApiHealthView, ApiHealthDbView, ApiHealthAuthView, ApiDocsView, TrendingTopicsView, SearchPostsView, UnifiedSearchView
from .feature_stub_views import (
    ActiveCallSessionView,
    CallSessionControlsView,
    CallSessionRespondView,
    CallSessionStartView,
    ConversationsView,
    ConversationPinView,
...
urlpatterns = [
    ...
    path('v1/messages/conversations/<uuid:user_id>/pin/', ConversationPinView.as_view(), name='messages-conversation-pin'),
    path('v1/messages/', MessageCreateView.as_view(), name='messages-create'),
    path('v1/messages/calls/start/', CallSessionStartView.as_view(), name='messages-calls-start'),
    path('v1/messages/calls/active/', ActiveCallSessionView.as_view(), name='messages-calls-active'),
    path('v1/messages/calls/<uuid:call_session_id>/<str:action>/', CallSessionRespondView.as_view(), name='messages-calls-respond'),
    path('v1/messages/calls/<uuid:call_session_id>/controls/', CallSessionControlsView.as_view(), name='messages-calls-controls'),
    path('v1/messages/<uuid:message_id>/', MessageUpdateView.as_view(), name='messages-update'),
    path('v1/messages/<uuid:message_id>/react/', MessageReactionView.as_view(), name='messages-react'),
    path('v1/messages/<uuid:message_id>/delete/', MessageDeleteView.as_view(), name='messages-delete'),
    ...
    path('v1/push-tokens/', PushTokenRegisterView.as_view(), name='push-token-register'),
